...
export default function LoginClient() {
    ...
    const postLogin = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            __DEV__ &&
                console.log("HASIL RESPONSE LOGIN BERHASIL : ", response);
            ...
            <div className="hidden lg:flex lg:w-7/12 relative flex-col justify-between p-12 bg-gradient-to-br from-[#0c1222] via-[#070b13] to-[#04060c] border-r border-slate-800/40 z-10 overflow-hidden">
                ...
                <div className="relative z-10 mt-auto max-w-lg">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed">
                        Access student metrics, process authentication,
                        configure platform structures, and manage critical data
                        models with an elegant administrative interface.
                    </p>
                </div>
            </div>
                ...
                <div className="w-full max-w-md flex flex-col gap-8">
                    ...
                    <form onSubmit={postLogin} className="flex flex-col gap-5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <label
                                htmlFor="remember-me"
                                className="text-xs text-slate-400 font-medium select-none cursor-pointer"
                            >
